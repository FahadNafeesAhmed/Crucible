...
Those modules pull in heavy dependencies (google-genai, torch, etc.)
that are not available in this lightweight Cloud Run container.
"""
import os
import json
import logging
...
async def list_tools():
    ...
    We hard-code the known tools to avoid spawning npx on every list call.
    """
    return [
        {
